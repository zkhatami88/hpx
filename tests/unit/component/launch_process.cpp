...
int hpx_main(boost::program_options::variables_map &vm)
{
    ...
    if (vm.count("launched")) {
        launch_target = vm["launched"].as < std::string > ();
      std::cout << "using launched: " << launch_target << std::endl;
      exe = launch_target;
    }
...
int main(int argc, char* argv[])
{
    ...
    desc_commandline.add_options()("launched,l", value<std::string>(),
